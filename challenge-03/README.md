...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é Reison do Vale!"
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso(); // "Eu peso 74 kg."
...
// Agora, apresente-se ;)
pessoa.apresentacao(); /* "Olá, eu sou o Reison do Vale, tenho 31 anos, 1.78, meu peso é 74 e, só hoje, eu já caminhei 50 metros!"*/
```
